...
def analyze_openfmri_dataset(data_dir, subject=None, model_id=None,
    ...
    datasource.inputs.raise_on_empty = False  #new code felice
    datasource.inputs.ignore_exception = True #new code
...
if __name__ == '__main__':
    ...
    crash_dir = '/home/fciccone/crash_files'  #new code
    
    wf.config['execution'] = dict(crashdump_dir=os.path.join(crash_dir,        #new code
							     'crashdumps'),
